  ...
  const Sidebar = () => (
    <aside className="w-60 bg-gray-900/80 backdrop-blur-xl border-r border-gray-800 flex flex-col h-full">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        {!isAdmin && (
          <p className="text-[10px] uppercase tracking-widest text-gray-600 px-3 mb-2 font-semibold">Menu</p>
        )}
        {navItems.map(item => (
          <NavItem
            key={item.path}
        ...
        {!isAdmin && <div className="border-t border-gray-800 my-3" />}
      </nav>
      ...
      <div className="border-t border-gray-800 p-4">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-400 hover:text-amber-400 hover:bg-amber-500/10 rounded-lg transition-all mb-1"
        >
